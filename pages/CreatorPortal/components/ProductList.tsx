          ...
          <div className="flex flex-col md:flex-row gap-4 w-full xl:w-auto">
            ...
            <div className="relative flex-grow md:flex-grow-0 group">
                <div className="flex items-center bg-white border border-stone-200 rounded-sm shadow-sm transition-all duration-300 focus-within:border-amber-700 focus-within:ring-1 focus-within:ring-amber-700/20 overflow-hidden">
                    ...
                    />
                    {isSearching && (
                        <button onClick={() => setSearch('')} className="pr-2 text-stone-300 hover:text-stone-600 transition-colors">
                            <X size={14} />
                        </button>
                    )}
                    <div className="pr-3 pl-3 border-l border-stone-100 text-stone-300 group-focus-within:text-amber-700 transition-colors flex items-center">
              ...
              {safeItems.length === 0 ? (
                  <div className="h-full min-h-[500px] flex flex-col items-center justify-center p-12 bg-gradient-to-b from-white to-stone-50/50">
                    <div className="relative mb-10 group cursor-default">
                        ...
                        <div className="relative w-28 h-28 bg-white border-2 border-stone-100 rounded-full flex items-center justify-center shadow-[0_10px_30px_rgba(0,0,0,0.05)] z-10">
