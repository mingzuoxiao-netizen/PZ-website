...
const Manufacturing: React.FC = () => {
  ...
  const MachinerySection = () => (
    <div className="animate-fade-in">
       <div className="bg-stone-50 p-6 md:p-12 mb-12 md:mb-16 rounded-sm flex flex-col md:flex-row items-center gap-8 md:gap-12">
          <div className="flex-1 order-2 md:order-1">
             <h3 className="font-serif text-2xl md:text-3xl text-stone-900 mb-4 md:mb-6">{t.manufacturing.machinery.title}</h3>
             ...
             <ul className="space-y-3 md:space-y-4">
                <li className="flex items-center text-xs md:text-sm font-bold uppercase tracking-wide text-stone-800">
                   <div className="w-6 md:w-8 h-[1px] bg-safety-700 mr-4"></div> {t.manufacturing.machinery.highPrecision}
                </li>
                <li className="flex items-center text-xs md:text-sm font-bold uppercase tracking-wide text-stone-800">
                   <div className="w-6 md:w-8 h-[1px] bg-safety-700 mr-4"></div> {t.manufacturing.machinery.autoFinish}
                </li>
                <li className="flex items-center text-xs md:text-sm font-bold uppercase tracking-wide text-stone-800">
                   <div className="w-6 md:w-8 h-[1px] bg-safety-700 mr-4"></div> {t.manufacturing.machinery.climate}
                </li>
             </ul>
          </div>
          <div className="flex-1 w-full h-56 md:h-[300px] bg-white border border-stone-200 p-2 shadow-sm order-1 md:order-2">
             <img 
       ...
       <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
          {machinery.map((m, idx) => (
             <div key={idx} className="bg-white border border-stone-200 p-6 md:p-8 hover:shadow-lg transition-shadow">
    ...
    <div className="animate-fade-in">
       <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-16 items-start">
          <div className="order-2 lg:order-1">
             ...
             <p className="text-stone-600 mb-8 md:mb-10 leading-relaxed text-sm md:text-base">
             ...
             <div className="space-y-6 md:space-y-8">
                <div className="flex gap-4 md:gap-6">
                   ...
                   <div>
                      ...
                      <p className="text-stone-500 text-xs md:text-sm">{t.manufacturing.qc.iqcDesc}</p>
                   </div>
                </div>
                <div className="flex gap-4 md:gap-6">
                   <div className="flex-shrink-0 mt-1 text-stone-300">
                       <Ruler size={28} className="md:w-8 md:h-8" />
                   </div>
                   <div>
                      <h4 className="font-bold text-stone-900 text-sm uppercase tracking-widest mb-2">{t.manufacturing.qc.ipqc}</h4>
                      <p className="text-stone-500 text-xs md:text-sm">{t.manufacturing.qc.ipqcDesc}</p>
                   </div>
                </div>
                <div className="flex gap-4 md:gap-6">
                   <div className="flex-shrink-0 mt-1 text-stone-300">
                   ...
                   <div>
                      ...
                      <p className="text-stone-500 text-xs md:text-sm">{t.manufacturing.qc.fqcDesc}</p>
                   </div>
                </div>
             </div>
          </div>
          
          <div className="order-1 lg:order-2 bg-stone-100 aspect-video md:h-[600px] relative overflow-hidden group">
             <img 
               src={config.manufacturing?.hero_qc}
               className="w-full h-full object-cover" 
               alt="QC Lab"
             />
             {/* Removed Compliance Overlay as requested */}
          </div>
       </div>
    </div>
  );
    ...
    <div className="bg-white min-h-screen pt-28 md:pt-32 pb-20">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="mb-12 md:mb-16 text-center max-w-4xl mx-auto">
          ...
          <h1 className="font-serif text-3xl md:text-6xl text-stone-900 mb-6 md:mb-8">
        ...
        {/* --- MOBILE/TABLET VIEW: VERTICAL STACK (WATERFALL) --- */}
        <div className="lg:hidden flex flex-col gap-20">
            <div className="relative">
                <div className="sticky top-[70px] bg-white/95 backdrop-blur z-20 py-4 border-b border-stone-100 mb-8">
                    <h2 className="font-bold text-stone-900 uppercase tracking-widest text-sm flex items-center">
                        <span className="w-2 h-2 bg-safety-700 mr-3 rounded-full"></span>
            ...
            <div className="relative">
                <div className="sticky top-[70px] bg-white/95 backdrop-blur z-20 py-4 border-b border-stone-100 mb-8">
                    <h2 className="font-bold text-stone-900 uppercase tracking-widest text-sm flex items-center">
                        <span className="w-2 h-2 bg-safety-700 mr-3 rounded-full"></span>
                        {t.manufacturing.tabs.machinery}
                    </h2>
                </div>
                <MachinerySection />
            </div>
