    ...
    <>
        ...
        <div className="relative z-10 h-full container mx-auto px-6 md:px-12 flex flex-col justify-center">
          <div className="max-w-4xl pt-20">
            ...
            <div className="flex flex-wrap gap-4">
              <Link to="/capabilities" className="bg-safety-700 text-white px-8 py-4 uppercase text-xs font-bold flex items-center">
                {t.home.heroBtnPrimary} <ArrowRight size={16} className="ml-2" />
              </Link>
              <Link to="/manufacturing" className="border border-stone-600 text-white px-8 py-4 uppercase text-xs font-bold">
                {t.home.heroBtnSecondary}
              </Link>
              <Link to="/materials" className="text-stone-300 px-6 py-4 uppercase text-xs font-bold">
      ...
      <section className="bg-white py-24">
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            {hubs.map((hub) => (
              <div
                ...
                className={`cursor-pointer p-4 border-l-4 mb-4 ${activeHub === hub.id ? 'border-safety-700 bg-stone-50' : 'border-stone-200'}`}
              >
          ...
          <div className="aspect-video border bg-stone-900">
            {currentHub?.image && (
              <img src={currentHub.image} alt={currentHub.title} className="w-full h-full object-cover" />
            )}
          </div>
        </div>
      </section>
      ...
      <section className="relative py-32 bg-stone-900 text-center">
        ...
        <div className="relative z-10">
          ...
          <Link to="/inquire" className="inline-block bg-safety-700 text-white px-12 py-4 uppercase text-xs font-bold">
