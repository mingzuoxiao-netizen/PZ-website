  ...
  return (
    <div className="bg-stone-50 pt-32 pb-20 min-h-screen">
      <div className="container mx-auto px-6 md:px-12">
        <h1 className="font-display font-black text-5xl md:text-7xl text-stone-900 mb-16 uppercase tracking-tighter border-l-8 border-safety-700 pl-8">{t.materials.title}</h1>
          ...
          {woods.map((wood) => (
            <div key={wood.name} className="group bg-white border border-stone-200 hover:border-safety-700 transition-all cursor-default shadow-sm">
              <div className="aspect-square w-full relative overflow-hidden">
                 ...
                 />
                 <div className="absolute inset-0 bg-stone-900/90 opacity-0 group-hover:opacity-100 transition-opacity flex flex-col justify-center p-6 text-center">
                    <p className="text-white text-xs leading-relaxed font-medium">{getStr(wood, 'desc')}</p>
                 </div>
              </div>
              <div className="p-4 border-t border-stone-100 bg-stone-50 group-hover:bg-white transition-colors">
                 <h4 className="text-stone-900 font-display font-bold text-sm uppercase tracking-wide text-center">{getStr(wood, 'name')}</h4>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 shadow-xl">
           <div className="lg:col-span-2 bg-white p-12 border-t-4 border-stone-900">
