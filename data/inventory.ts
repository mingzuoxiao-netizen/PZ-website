...
export const categories: Category[] = [
  {
    ...
    description: "Solid wood tables ranging from nesting sets to grand dining tables.",
  ...
  },
  {
    ...
    description: "Precision-crafted storage solutions.",
  ...
  },
  {
    ...
    description: "Exquisite veneer work showcasing rare wood figures.",
